...
<script type="text/ecmascript-6">
  export default {
    ...
    computed: {
      ...
      userInfo() {
        return this.$store.state.userInfo || [{author: {}}]
      }
    },
    methods: {
      showAsideMenu() {
  ...
  .aside-menu {
    ...
    .menu {
      ...
      .infos {
        ...
        .icon-msg {
          background: url('./icon-msg-blue.svg');
          background-size: contain;
        }
        .icon-collect {
          background: url('./icon-collect.svg');
          background-size: contain;
        }
        .icon-msg {
          background: url('./icon-msg-blue.svg');
        ...
        .cnode {
          ...
          background: url('./icon-cnode.svg') no-repeat;
          background-size: contain;
          opacity: .1;
        }
      }
